 ...
 */
public class FormMIDletRecorded extends MIDlet implements CommandListener {
    ...
    private void appendImageItemPlain(final Form form) {
        try {
            final Image image = Image.createImage(getClass().getResourceAsStream("/res/car.png"));
            ImageItem imageItemPlain = new ImageItem("imageItemLabelPlain", image, Item.LAYOUT_CENTER,
                    "altTextPlain", Item.PLAIN);
    ...
    private void appendStringItemButton(final Form form) {
        StringItem stringItemButton = new StringItem("stringItemButtonLabel", "defStringItemButtonValue",
                Item.BUTTON);
