...
mv.visitMethodInsn(INVOKESTATIC, "org/robotme/core/recorder/RobotMERecorder", "getInstance", "()Lorg/robotme/core/recorder/RobotMERecorder;");
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKEVIRTUAL, "org/robotme/core/recorder/RobotMERecorder", "setMIDlet", "(Ljavax/microedition/midlet/MIDlet;)V");
mv.visitInsn(RETURN);
Label l3 = new Label();
mv.visitLabel(l3);
...
mv.visitFieldInsn(GETSTATIC, "org/example/midlet/TestTextBoxMIDlet", "CMD1_EXIT", "Ljavax/microedition/lcdui/Command;");
mv.visitVarInsn(ALOAD, 1);
mv.visitMethodInsn(INVOKEVIRTUAL, "org/robotme/core/recorder/RobotMERecorder", "commandAddedToDisplayable", "(Ljavax/microedition/lcdui/Command;Ljavax/microedition/lcdui/Displayable;)V");
Label l7 = new Label();
mv.visitLabel(l7);
...
mv.visitMethodInsn(INVOKESTATIC, "org/robotme/core/recorder/RobotMERecorder", "getInstance", "()Lorg/robotme/core/recorder/RobotMERecorder;");
mv.visitVarInsn(ALOAD, 1);
mv.visitMethodInsn(INVOKEVIRTUAL, "org/robotme/core/recorder/RobotMERecorder", "setCurrentDisplayable", "(Ljavax/microedition/lcdui/Displayable;)V");
mv.visitLabel(l1);
...
mv.visitMethodInsn(INVOKEVIRTUAL, "org/robotme/core/recorder/RobotMERecorder", "commandIvoked", "(Ljavax/microedition/lcdui/Command;Ljavax/microedition/lcdui/Displayable;)V");
Label l0 = new Label();
mv.visitLabel(l0);
