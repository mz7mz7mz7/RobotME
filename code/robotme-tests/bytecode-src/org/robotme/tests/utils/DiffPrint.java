package org.robotme.tests.utils;
...
//    }
    ...
    public void diff(String file1, String file2, Writer writer) throws IOException {
        String[] a = slurp(file1);
        String[] b = slurp(file2);
        Diff d = new Diff(a, b);
//        char style = 'n';
//        for (int i = 0; i < argv.length - 2; ++i) {
//            String f = argv[i];
